    ...
    return data.map(cs => {
      return (
        <tr>
          ...
          <td>{cs.cs_name}</td>
          <td>{cs.id_status}</td>
          <td><button type="submit" class="btn btn-orange">Rate</button></td>
        </tr>
      )
    })
  }
...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td>Otto</td>
      <td>@mdo</td>
      <td><button onClick={() => history.push('./DetailComplaintCS')} type="submit" class="btn btn-warning">Detail</button></td>
    </tr>
    <tr>
      <th scope="row">2</th>
      <td>Jacob</td>
